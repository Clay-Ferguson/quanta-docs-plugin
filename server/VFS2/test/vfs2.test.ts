...
export async function checkAuthTest(owner_id: number): Promise<void> {
    ...
    try {
        console.log('=== VFS2 Check Auth Test Starting ===');
        ...
        console.log('=== VFS2 Check Auth Test Completed Successfully ===');
        
    } catch (error) {
        console.error('=== VFS2 Check Auth Test Failed ===');
        console.error('Error during VFS2 check auth test:', error);
        throw error;
    } finally {
        // Always clean up test data, even if test fails
        console.log('Final cleanup of test data...');
