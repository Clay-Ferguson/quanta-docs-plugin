...
export async function moveUpOrDownTest2(owner_id: number): Promise<void> {
    try {
        console.log('=== VFS2 MoveUpOrDown Test 2 Starting ===');
        ...
        console.log('=== VFS2 MoveUpOrDown Test 2 Completed Successfully ===');
        
    } catch (error) {
        console.error('=== VFS2 MoveUpOrDown Test 2 Failed ===');
        console.error('Error during VFS2 moveUpOrDown test 2:', error);
        throw error;
    }
}
